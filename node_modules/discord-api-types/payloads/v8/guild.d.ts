 ...
 */
export declare const enum GuildDefaultMessageNotifications {
    AllMessages = 0,
    OnlyMentions = 1
}
/**
 ...
 */
export declare const enum GuildExplicitContentFilter {
    Disabled = 0,
 ...
 */
export declare const enum GuildWidgetStyle {
    /**
...
export declare const enum MembershipScreeningFieldType {
    /**
     * Server Rules
     */
    Terms = "TERMS"

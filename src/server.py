from config import EDITOR_IDS, ADMIN_IDS, APPROVAL_IDS, BLACKLISTED_IDS, REPORTER_IDS, BASE_URL, CLIENT_ID, new_disabled, CONFIG
            ...
            await s.post(os.getenv('newentry_hook'), json={
                'embeds': [{
                    ...
                    'fields': [
                        ...
                        {'name': 'unlisted', 'value': str(
                            unlisted), 'inline': False},
                        {'name': 'id', 'content': entry_id},
                        {'name': 'link',
                         'content': 'https://repldex.com/entry/' + entry_id}
                    ]
                }]
            })
